...
# Это совокупность действий и понятий, определяющих стиль написания компьютерных программ.

# Императивная парадигма - последовательное выполнение операций. Включает в себя:
# Процедурное (C, Pascal, Cobol)
# Объектно-ориентированное (Java, Python, C++)

# Декларативная парадигма - описывает, что нужно получить, а не как это сделать (SQL). Включает
# Функциональное программирование
# Логическое программированиев

"""Типизация"""
# Это система правил работы с данными с ЯП, определяющая как язык распознаёт типы переменных, какие операции допустимы и
