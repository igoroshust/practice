...
# n = int(input())
#
# for i in range(1, n + 1):  # Внешний цикл для строк
#     # Печатаем числа от 1 до i
#     for j in range(1, i + 1):
#         print(j, end='')  # Печатаем текущее число без пробела
#
#     # Печатаем числа от i-1 до 1
#     for j in range(i - 1, 0, -1):
#         print(j, end='')  # Печатаем текущее число без пробела
#
#     print()  # Переход на новую строку после завершения строки

"""Создание численного треугольника с заданной высотой"""
# n = int(input())
#
# current_number = 1  # Начальное число
#
# for i in range(1, n + 1):  # Внешний цикл для строк
#     for j in range(i):  # Внутренний цикл для чисел в строке
#         print(current_number, end=' ')  # Печатаем текущее число
#         current_number += 1  # Увеличиваем текущее число на 1
