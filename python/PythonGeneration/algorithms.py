...
# Алгоритм сортировки простыми вставками (Insert sort) делит список на 2 части - отсортированную и неотсортированную.
...
# Работа алгоритма на примере сортировки (по возрастанию) списка a = [5, 1, 8, 2, 4]

# Первый проход: делим список на две части: отсортированную [5] и неотсортированную [1, 8, 2, 4]
# Извлекаем первый элемент (1) из неотсортированной части списка и находим ему место в отсортированной части: [1, 5, 8, 2, 4]

# Второй проход: делим список на две части: отсортированную [1, 5] и неотсортированную [8, 2, 4]
# Извлекаем первый элемент (8) из неотсортированной части списка и находим ему место в отсортированной части: [1, 5, 8, 2, 4]

# Третий проход: делим список на две части: отсортированную [1, 5, 8] и неотсортированную [2, 4]
# Извлекаем первый элемент (2) из неотсортированной части списка и находим ему место в отсортированной части: [1, 2, 5, 8, 4]

# Четвёртый проход: делим список на две части: отсортированную [1, 2, 5, 8] и неотсортированную [4]
# Извлекаем первый элемент (4) из неотсортированной части списка и находим ему место в отсортированной части: [1, 2, 4, 5, 8]
# Список отсортирован, алгоритм завершён.


# Реализация алгоритма на примере сортировки списка по возрастанию
# a = [1, 7, -3, 9, 0, -67, 34, 12, 45, 1000, 6,  8, -2, 99]
# n = len(a)

# for i in range(1, n):
#     elem = a[i] # берём первый элемент из неотсортированной части списка
#     j = i
#
...
#         j -= 1
#
#     # Нашли место для текущего элемента из неотсортированной чатси
#     # Вставляем его на индекс j в отсортированной чатси
#     a[j] = elem
#
# print('Отсортированный список: ', a)
...
# очередного элемента из неотсортированной части списка посредством бинарного поиска.
