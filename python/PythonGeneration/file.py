...
Напишите программу, использующую списочное выражение, которая выведет квадраты чётных чисел, кроме тех квадратов,
...
"""Вывести в столбик поданные на вход слова"""
# print('\n'.join(input().split()))


"""Вывести кубы введённых чисел"""
# print(' '.join(map(str, [i**3 for i in map(int, input().split())])))


"""Вывести квадраты от 1 до введённого числа"""
# print('\n'.join(map(str, (i**2 for i in range(1, int(input()) + 1)))))


"""Вывести числа палиндромы от 100 до 1000 (включительно)"""
# print(palindromes := [i for i in range(100, 1000+1) if str(i) == str(i)[::-1]])


"""Вывод списка из десяти нулей"""
# print((zeros := [0] * 10))
